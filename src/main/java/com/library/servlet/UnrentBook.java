...
public class UnrentBook extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request,
		...
		// Delete Loan
		Loan loan = loanDao.getLoanByID((String) request.getParameter("aLoan"));
		bookDao.increaseCopies(loan.getBookId());
	...
	protected void doPost(HttpServletRequest request,
		...
		/*
		 * Session session =
		 * HibernateUtil.getSessionFactory().getCurrentSession(); Loan loan =
		 * null;
		 * 
		 * 
		 * loan.setBookId((String) request.getAttribute("aLoan")); LoanDao
		 * loanDao = new LoanDao (session); System.out.print("Deleting..");
