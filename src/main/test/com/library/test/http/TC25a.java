...
public class TC25a extends TestCase {
	...
	public void tearDown() throws Exception {
		// Delete the loan
		logger.info("Entered tear down for TC25a");
		...
		// close the session
		session.close();
		logger.info("Exit tear down for TC25a");
	}
	...
	public void testDeleteBookWithMultipleCopies() throws Exception {
		...
		requestReturnBook = new GetMethodWebRequest(Constant.UNRENT_BOOK_URL
				+ loan2.getLoanId() + "&userid=" + user.getUserId());
